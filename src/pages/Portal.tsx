...
import { Shield, Briefcase, ClipboardList, HardHat, Timer } from "lucide-react";
...
const Portal = () => {
  ...
  const portalOptions = [
    ...
    },
    {
      ...
      icon: ClipboardList,
      href: "/runsheets",
      color: "bg-sheets/10 text-sheets",
    },
    {
      title: "TimeSheets",
      description: "Complete and submit daily timesheets",
      icon: Timer,
      href: "/timesheets",
      color: "bg-time/10 text-time",
    },
    {
      title: "Admin Control",
      description: "Create and edit users, clients, projects and manage settings",
      icon: Shield,
      href: "/admin-control",
